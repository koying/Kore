 ...
 */
public class PlaybackOverlayActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSession = new MediaSession (this, "Kore");
    ...
    public void onFragmentPlayPause(Media media, int position, Boolean playPause) {
        mVideoView.setVideoPath(media.getVideoUrl());
    ...
    private void updateMetadata(final Media media) {
        final MediaMetadata.Builder metadataBuilder = new MediaMetadata.Builder();

        String title = media.getTitle().replace("_", " -");

        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_TITLE, title);
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_SUBTITLE,
                media.getDescription());
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_DISPLAY_ICON_URI,
                media.getCardImageUrl());

        // And at minimum the title and artist for legacy support
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_TITLE, title);
        metadataBuilder.putString(MediaMetadata.METADATA_KEY_ARTIST, media.getStudio());

        Glide.with(this)
            .load(Uri.parse(media.getCardImageUrl()))
            .asBitmap()
